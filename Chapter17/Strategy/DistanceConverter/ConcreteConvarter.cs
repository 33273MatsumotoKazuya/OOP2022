...
namespace DistanceConverter {
    ...
    public class MeterConvarter : ConverterBase {
    ...
    public class FeetConvarter : ConverterBase {
    ...
    public class InchConvarter : ConverterBase {
    ...
    public class YardConvarter : ConverterBase {
    ...
    public class KiloMeterConvarter : ConverterBase {
    ...
    public class MileConvarter : ConverterBase {
